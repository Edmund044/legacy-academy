...
<div className="grid grid-cols-1 lg:grid-cols-4 gap-6 min-w-0">
  ...
  <div className="lg:col-span-1 min-w-0">
    <div className="space-y-2">
      ...
      <input
        className="w-full h-9 pl-3 pr-4 rounded-lg border border-input bg-white text-sm focus:outline-none focus:ring-2 focus:ring-brand/20"
        placeholder="Search players..."
      />

      <div className="max-h-[calc(100vh-180px)] overflow-y-auto space-y-2 pr-1">
        {players.map(p => (
          <div
            key={p.id}
    ...
    <Card className="w-full min-w-0">
      <CardContent className="pt-5 min-w-0">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <Avatar className="h-16 w-16 border-2 border-white shadow shrink-0">
              ...
              <div className="min-w-0">
                ...
                <div className="flex flex-wrap gap-1.5 mt-1">
                  ...
                  <Badge
                    ...
                    className="text-[10px]"
                  >
                    {selected?.group_name?.name || "Under 11"}
                  </Badge>
        ...
        >
          ...
          <TabsList className="flex h-auto w-fit flex-col m-4 items-stretch justify-start shrink-0">

            <TabsTrigger
              className="justify-start"
              value="overview"
            >
              <Dumbbell className="w-4 m-2 h-4" />
              Executive Summary
            </TabsTrigger>
          ...
          <div className="flex-1 min-w-0">
                    ...
                    <div className="space-y-2">
                      ...
                      {selected &&
                        ...
                        Object.entries(selected.physical).map(([k, v]) => (
                          ...
                          <div
                            key={k}
                            className="flex justify-between py-1.5 px-3 bg-muted/40 rounded-lg"
                          >
            ...
            <TabsContent value="tactical">
              ...
              <div className="h-48 flex items-center justify-center bg-muted/30 rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">
                  Tactical analysis visualisation coming soon
                </p>
            ...
            <TabsContent value="scouting">
              ...
              <div className="h-48 flex items-center justify-center bg-muted/30 rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">
                  Scouting notes will appear here
                </p>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                ...
                {[
                  ...
                  >
                    ...
                    <p className="absolute bottom-2 left-2 right-2 text-[10px] font-medium text-white bg-black/50 rounded px-1.5 py-0.5 truncate">
                      {v}
                    </p>
            ...
            {/* ======================================================= */}
            {/* OTHER EXISTING TAB CONTENTS */}
            {/* ======================================================= */}

            <TabsContent value="evidence">
              {/* Keep your existing Evidence & Confidence Snapshot content here */}
            </TabsContent>

            <TabsContent value="track">
              {/* Keep your existing Track Record content here */}
            </TabsContent>

            <TabsContent value="visual">
              {/* Keep your existing Visual Performance Profile content here */}
            </TabsContent>

            <TabsContent value="domain">
              {/* Keep your existing Four Domain Assessment content here */}
            </TabsContent>

            <TabsContent value="load">
              {/* Keep your existing Competitive Load content here */}
            </TabsContent>

            <TabsContent value="fit">
              {/* Keep your existing Tactical Fit content here */}
            </TabsContent>

            <TabsContent value="destination">
              {/* Keep your existing Destination Scenarios content here */}
            </TabsContent>

            <TabsContent value="recommendation">
              {/* Keep your existing Final Recommendation content here */}
            </TabsContent>
