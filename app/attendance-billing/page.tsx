...
export default function SessionsPage() {
  ...
  const fetchSubscriptions = async () => {
    try {
      const response = await apiClient<ApiResponse<Subscription[]>>({
        endpoint: `/v1/billing/attendance-billing?page=1&per_page=100`,
        method: "GET",
        headers: {
  ...
  return (
    <>
      <PageHeader title="Attendance Billing" description="Detailed overview of attendance billing revenue performance.">
      </PageHeader>
