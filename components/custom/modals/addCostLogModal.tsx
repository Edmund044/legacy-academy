...
const CATEGORY = [
  { id: "d58e4f8cc-2ed3-4248-862c-e590d61f15ec", label: "Transport" },
  { id: "d584ff8cc-2ed3-4248-862c-e590d61f16ec", label: "Football Boots" },
  { id: "d584fs8cc-2ed3-4248-862c-e590d61f17ec", label: "School Fees" },
  { id: "d584f8acc-2ed3-4248-862c-e590d61f18ec", label: "Food" },
  { id: "d584f8acc-2ed3-4248-862c-e590d61f19ec", label: "Accommodation" },
  { id: "d584f8cdc-2ed3-4248-862c-e590d61f20ec", label: "Training Kits" },
  { id: "d584f8cac-2ed3-4248-862c-e590d61f17ec", label: "Medical" },
  { id: "d584f8caac-2ed3-4248-862c-e590d61f18ec", label: "Other" },
        ...
        <div className="px-6 pb-6 space-y-5 overflow-y-auto max-h-[80vh]">
          ...
          {/* Full Name + Role */}
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                  placeholder="e.g. Description of the cost"
                  value={form.description}
                  onChange={(e) =>
                    setForm((prev) => ({ ...prev, description: e.target.value }))
                  }
                  className="placeholder:text-gray-400 w-full h-24 border rounded-md p-2"
                  />
                </div>
                </div>
